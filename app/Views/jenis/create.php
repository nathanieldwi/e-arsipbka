                    ...
                    <div class="card-body">
                        <form action="<?= base_url('jenis/store') ?>" method="post">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?= validation_errors('nama_jenis') ? 'is-invalid' : '' ?>" name="nama_jenis" id="nama_jenis" autocomplete="off" placeholder="Masukan Nama Jenis" value="<?= set_value('nama_jenis') ?>">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control <?= validation_errors('detail') ? 'is-invalid' : '' ?>" name="detail" id="detail" cols="30" rows="3" placeholder="Masukan Detail"><?= set_value('detail') ?></textarea>
