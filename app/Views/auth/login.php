                ...
                <div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        ...
                        <div class="text-center mt-4">
                            <img src="<?= base_url() ?>assets/img/logo-kemahasiswaan-kotak.png" alt="logo-kemahasiswaan-kotak" class="img-fluid">
                            <h1 class="h1">E-Arsip Biro Kemahasiswaan dan Alumni UNMER Malang</h1>
                        </div>
